...
--%>                       
        ...
        <div class="form-row">
            ...
            <div class="field-widget"><input type="text" name="jydz" value="${people.jydz}"/></div>
        </div>
		...
		<div class="form-row">
            ...
            <div class="field-widget"><input type="text" name="zzdz" value="${people.zzdz}"/></div>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="field-widget"><input type="text" name="f5_qt" value="${people.f5_qt}"/></div>
        </div>
