...
<body>
<h1 align="center">黄石港区新的社会阶层人士</h1>
...
--%>    
        ...
        <div class="form-row">
            <div class="field-label">创办机构名称及职务：</div>
            <div class="field-widget"><input type="text" name="jgmcjzw" value="${people.jgmcjzw}"/></div>
        </div>

        <div class="form-row">
            <div class="field-label">所获专利或生产主导产品：</div>
            <div class="field-widget"><input type="text" name="shzl" value="${people.shzl}"/></div>
        </div>
