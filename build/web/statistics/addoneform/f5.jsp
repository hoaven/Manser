...
<body onload="getGrid()">
	<c:if test="${people==null}">
		<h1 align="center">黄石港区少数民族流动人口</h1>
	...
	<c:if test="${people!=null}">
		<h1 align="center">黄石港区少数民族流动人口信息修改</h1>
		<div class="form_content">
			<form
...
--%>
		...
		<div class="form-row">
			...
			<div class="field-widget">
				<input type="text" name="hjdz" value="${people.hjdz}" />
			</div>
		</div>

		<div class="form-row">
			<div class="field-label">经营地址：</div>
			<div class="field-widget">
				<input type="text" name="jydz" value="${people.jydz}" />
			</div>
		</div>
		...
		<div class="form-row">
			...
			<div class="field-widget">
				<input type="text" name="hylb" value="${people.hylb}" />
			</div>
		</div>
		<div class="form-row">
			<div class="field-label">身份证号：</div>
		...
		<div class="form-row">
			<div class="field-label">租住地址：</div>
			<div class="field-widget">
				<input type="text" name="zzdz" value="${people.zzdz}" />
			</div>
		</div>
		...
		<div class="form-row">
			...
			<div class="field-widget">
				<input type="text" name="f5_qt" value="${people.f5_qt}" />
			</div>
		</div>
