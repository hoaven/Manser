...
<body onload="getGrid()">
	<c:if test="${people==null}">
		<h1 align="center">黄石港区华侨、归侨及侨眷</h1>
	...
	<c:if test="${people!=null}">
		<h1 align="center">黄石港区华侨、归侨及侨眷信息修改</h1>
		<div class="form_content">
			<form
...
--%>
				...
				<div class="form-row">
					<div class="field-label">所在国家：</div>
					<div class="field-widget">
						<input type="text" name="szgj" value="${people.szgj}" />
					</div>
				</div>


				<div class="form-row">
					<div class="field-label">与侨关系：</div>
					<div class="field-widget">
						<select name="yqgx" id="yqgx"">
							<option value="香港同胞">华侨&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
							<option value="澳门同胞">归侨</option>
							<option value="港胞家属">侨眷</option>
						</select>
					</div>
				</div>
				...
				<div class="form-row">
					...
					<div class="field-widget">
						...
						<c:if test="${community==null||community eq ''}">
							<select name="community" id="community" onmouseover="getTwo()">
