...
<head lang="en">
    <meta charset="UTF-8">
    <title>黄石港区民主党派成员修改表</title>
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/statistics/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/statistics/community.css">
    <style type="text/css">
        .form_content{
            width:575px;
            margin:30px auto;
...
--%>                       
        ...
        <div class="form-row">
            <div class="field-label">加入党派时间：</div>
            <div class="field-widget"><input type="text" name="rdsj" value="${people.rdsj}"/></div>
        </div>
        ...
        <div class="form-row">
            <div class="field-label">工作职务：</div>
