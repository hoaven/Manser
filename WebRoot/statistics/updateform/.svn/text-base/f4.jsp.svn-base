...
<div class="form_content">
    <form action="${pageContext.request.contextPath}/servlet/AdminServlet?operation=realupdateone&pid=${people.id}" method="post">
		...
		<div class="form-row">
            ...
            <div class="field-widget"><input type="text" name="fm" value="${people.fm}"/></div>
        </div>
...
--%>                       
        ...
        <div class="form-row">
            ...
            <div class="field-widget"><input type="text" name="zics" value="${people.zjcs}"/></div>
        </div>

        <div class="form-row">
            <div class="field-label">宗教任职：</div>
            <div class="field-widget"><input type="text" name="zjrz" value="${people.zjrz}"/></div>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="field-widget"><input type="text" name="f4_qt" value="${people.f4_qt}"/></div>
        </div>
