...
<head lang="en">
<meta charset="UTF-8">
<title>黄石港区台湾同胞及其在大陆亲属修改表</title>
...
<body onload="getGrid()">
	<c:if test="${people==null}">
		<h1 align="center">黄石港区台湾同胞及其在大陆亲属</h1>
	...
	<c:if test="${people!=null}">
		<h1 align="center">黄石港区台湾同胞及其在大陆亲属信息修改</h1>
		<div class="form_content">
			<form
...
--%>
		...
		<div class="form-row">
			<div class="field-label">与台胞关系：</div>
			<div class="field-widget">
				<input name="ytbgx" type="radio" value="台湾同胞" />台湾同胞&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input name="ytbgx" type="radio" value="台胞家属" />台胞家属
			</div>
		</div>
