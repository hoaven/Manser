...
<body onload="getGrid()">
	...
	<c:if test="${people!=null}">
		<h1 align="center">黄石港区党外知识分子信息修改</h1>
		<div class="form_content">
			<form
...
--%>
		...
		<div class="form-row">
			<div class="field-label">毕业院校及专业：</div>
			<div class="field-widget">
				<input type="text" name="byyx" value="${people.byyx}" />
			</div>
		</div>
