...
<body onload="getGrid()">
	<c:if test="${people==null}">
		<h1 align="center">其他需要联系的统战对象</h1>
	...
	<c:if test="${people!=null}">
		<h1 align="center">其他需要联系的统战对象信息修改</h1>
		<div class="form_content">
			<form
	...
	<fieldset>
		...
		<div class="form-row">
			<div class="field-label">专业特长：</div>
			<div class="field-widget">
				<input type="text" name="zytc" value="${people.zytc}" />
			</div>
		</div>
