		...
		<table id="tableColor" cellpadding="0" cellspacing="0" border="0px"
			...
			<c:forEach items="${peoples}" var="people" varStatus="vs">
				<tr>
					...
					<td><input type="text" name="dpmc" value="${people.dpmc}" />
					</td>
					<td><input type="text" name="education" value="${people.education}" />
					</td>
					<td><input type="text" name=qymc value="${people.qymc}" />
					</td>
					<td><input type="text" name="qydz" value="${people.qydz}" />
					</td>
					<td><input type="text" name="dwzw" value="${people.dwzw}" />
					</td>
					<td><input type="text" name="zc" value="${people.zc}" />
					</td>
					<td><input type="text" name="fddbr" value="${people.fddbr}" />
					</td>
					<td><input type="text" name="cbsj" value="${people.cbsj}" />
					</td>
					<td><input type="text" name="hycp" value="${people.hycp}" />
					</td>
