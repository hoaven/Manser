...
function getTwo() {
	...
	if (value != "中共黄石港区委统战部") {
		...
		document.getElementById("two").options.add(new Option("江北管理区",
		"江北管理区")); // 添加提示option
		
		document.getElementById("two").options.add(new Option("花湖街道办事处",
		"花湖街道办事处")); // 添加提示option
		
		document.getElementById("two").options.add(new Option("黄石港片区管理委员会",
		"黄石港片区管理委员会")); // 添加提示option
		
		document.getElementById("two").options.add(new Option("环磁湖片区管理委员会",
		"环磁湖片区管理委员会")); // 添加提示option
		
		document.getElementById("two").options.add(new Option("胜阳港片区管理委员会",
		"胜阳港片区管理委员会")); // 添加提示option
